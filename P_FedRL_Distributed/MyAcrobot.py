...
class MyAcrobotEnv(MyEnv):
    ...
    **REFERENCE:**
    ...
    def __init__(self, para=0.5, mode='link_length_1'):
        super(MyAcrobotEnv, self).__init__(para)
        self.viewer = None
        ...
        if mode == 'link_mass_1':
            self.LINK_MASS_1 = 0.5 + para
        elif mode == 'link_mass_2':
            self.LINK_MASS_2 = 0.5 + para
        elif mode == 'link_length_1':
            self.LINK_LENGTH_1 = 0.5 + para
        elif mode == 'link_length_2':
            self.LINK_LENGTH_2 = 0.5 + para
        else:
            raise
    ...
    def step(self, a):
        ...
        if self.current_step >= self.step_ub:
            terminal = True
...
class Mass1_MyAcrobotEnv(MyEnv):
    ...
    **REFERENCE:**
    ...
    def __init__(self, para=0.5):
        mode = 'link_mass_1'
        super(Mass1_MyAcrobotEnv, self).__init__(para)
        self.viewer = None
        self.LINK_LENGTH_1 = 1.0
        self.LINK_LENGTH_2 = 1.0
        self.LINK_MASS_1 = 1.0
